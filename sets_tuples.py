...
# print(tuple1 [0])#output:5
# print(tuple3[3])#output:3
# #count the number of occurrences of an element in a tuple
# print(len(tuple1))#output:2
...
#Suppose we have a dictionary containing multiple lists as values, 
#and you want to access a specific element from one of these lists.
...
print(sample_list_of_dicts["dicts"][2]["name"]) #output:30
print(sample_list_of_dicts["dicts"][0]["age"]) #output:30
...
print(data["fruits"]["tropical"])  # Output: 'pineapple'
print(data["prices"]["pineapple"])  # Output: 'prices'
